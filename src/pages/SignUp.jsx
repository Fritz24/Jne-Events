...
export default function SignUp() {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            setError(err.message || t.failedSignUp || "Failed to create account. Please try again.");
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen flex flex-col items-center pt-8 sm:pt-20 pb-12 px-6">
            ...
            >
                <div className="text-center space-y-2 mb-6">
                    ...
                    <p className="text-white/40">{t.signUpSubtitle || "Join JnE Events to get notified and book easily"}</p>
                </div>
